...
class ApiClient {
  ...
  async resourceAction(options) {
    ...
    if (method === 'POST') {
      ...
      axiosParams.headers['X-Csrf-Token'] = csrfToken.sk;
    }
  ...
  async bulkAction(options) {
    var _axiosParams$method, _axiosParams$method2;
    ...
    const method = (_axiosParams$method = axiosParams.method) !== null && _axiosParams$method !== void 0 && _axiosParams$method.toUpperCase() || data ? 'POST' : 'GET';

    if (((_axiosParams$method2 = axiosParams.method) === null || _axiosParams$method2 === void 0 ? void 0 : _axiosParams$method2.toUpperCase()) === 'POST' || method === 'POST') {
      const csrfToken = await this.getToken();
      axiosParams.headers['X-Csrf-Token'] = csrfToken.sk;
    }
